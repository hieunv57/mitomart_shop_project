            ...
            <section class="breadcrumbs">
                <div class="container">
                    <ul class="horizontal_list clearfix bc_list f_size_medium">
                        ...
                        <li><a href="#" class="default_t_color">Sản phẩm được quan tâm</a></li>
                    </ul>
                </div>
            </section>
            <!--content-->
                ...
                <div class="container">
                    <div class="row clearfix">
                        ...
                        <section class="col-lg-9 col-md-9 col-sm-9">
                            <h2 class="tt_uppercase color_dark m_bottom_25">Sản phẩm được quan tâm</h2>
                            ...
                            <div class="row clearfix m_bottom_15">
                                <div class="col-lg-7 col-md-7 col-sm-8 col-xs-12 m_xs_bottom_10">
                                    <p class="d_inline_middle f_size_medium d_xs_block m_xs_bottom_5">Tổng số: {{$total}} sản phẩm</p>
                                </div>
                            ...
                            <section class="products_container category_grid clearfix m_bottom_15">
                                <!--product item-->
                                @foreach($product_mostview as $item)
