					...
					<div class="row clearfix">
						...
						<div class="p_top_10 t_xs_align_l">
							...
							<table class="description_table m_bottom_5">
								<tr>
									<td>Chiều dài:</td>
									<td><span class="color_dark">{{$product_detail->width}} cm</span></td>
								</tr>
								<tr>
									<td>Chiều rộng:</td>
							...
							@if($product_detail->discount > 0)
								<s class="v_align_b f_size_ex_large">{{number_format($product_detail->price)}}</s><span class="v_align_b f_size_big m_left_5 scheme_color fw_medium">{{number_format($product_detail->price * $product_detail->discount)}} đồng</span>
							@else
								<span class="v_align_b f_size_big m_left_5 scheme_color fw_medium">{{number_format($product_detail->price)}} đồng</span>
							@endif
							...
							<div class="d_ib_offset_0 m_bottom_20">
								<a href="{!! url('mua-hang', [$product_detail->link]) !!}"><button class="button_type_4 bg_scheme_color r_corners tr_all_hover color_light mw_0">THÊM VÀO GIỎ</button></a>
								<button class="button_type_12 bg_light_color_2 tr_delay_hover d_inline_b r_corners color_dark m_left_5 p_hr_0"><span class="tooltip tr_all_hover r_corners color_dark f_size_small">Yêu thích</span><i class="fa fa-heart-o f_size_big"></i></button>
							</div>
							<p class="d_inline_middle">Chia sẻ sản phẩm</p>
					...
					<div class="tabs m_bottom_45">
						...
						<nav>
							<ul class="tabs_nav horizontal_list clearfix">
								...
								<li class="f_xs_none"><a href="#tab-3" class="bg_light_color_1 color_dark tr_delay_hover r_corners d_block">Video giới thiệu, hướng dẫn</a></li>
							</ul>
						</nav>
						<section class="tabs_content shadow r_corners">
							<div id="tab-1">
								...
								Danh mục <a href="#" class="color_dark">black</a>
							</div>
							<div id="tab-2">
