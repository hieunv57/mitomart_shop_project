                ...
                <div id="table-action" class="row">
                    <div class="col-lg-12">
                        <ul id="tableactiondTab" class="nav nav-tabs">
                            <li class="active"><a href="#table-table-tab" data-toggle="tab">Thêm mới thành viên</a></li>
                        </ul>
                                    ...
                                    <div class="col-lg-12">
                                        <div class="panel-body pan">
                                                ...
                                                <input type="hidden" name="_token" value="{{ csrf_token() }}">
                                                    <div class="form-body">
                                                        <div class="form-group"><label for="inputFirstName" class="col-md-3 control-label">Địa chỉ email<span class='require'>*</span></label>

                                                            <div class="col-md-4"><input name="email" type="email" placeholder="email" required="required" class="form-control"/></div>
                                                        </div>
                                                        <div class="form-group"><label for="inputFirstName" class="col-md-3 control-label">Mật khẩu<span class='require'>*</span></label>

                                                            <div class="col-md-4"><input name="password" type="password" placeholder="password" required="required" class="form-control"/></div>
                                                        </div>
                                                        <div class="form-group"><label for="inputFirstName" class="col-md-3 control-label">Xác nhận mật khẩu<span class='require'>*</span></label>

                                                            <div class="col-md-4"><input name="password_confirmation" type="password" required="required" placeholder="confirm password" class="form-control"/></div>
                                                        </div>
                                                    </div>
