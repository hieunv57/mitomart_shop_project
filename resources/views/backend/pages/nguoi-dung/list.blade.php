                ...
                <div id="table-action" class="row">
                    <div class="col-lg-12">
                        <ul id="tableactiondTab" class="nav nav-tabs">
                            ...
                            <form method="POST" class="form-horizontal form-label-left" action="{{asset('admin/thanh-vien/tim-kiem')}}">
                                <input type="hidden" name="_token" value="{{ csrf_token() }}">
                                    <div class="form-group">
                                        <div class="col-sm-6">
                                            <div class="input-group">
                                                <input class="form-control" name="search" value="" placeholder="Nhập từ khóa tìm kiếm">
                        ...
                        <div class="portlet-header pam mbn">
                            <div class="actions"><a href="{{asset('admin/thanh-vien/them-moi')}}" class="btn btn-info btn-sm"><i class="fa fa-plus"></i>&nbsp;
                                Thêm mới</a>&nbsp;
                            </div>
                        </div>
                                ...
                                <div class="row">
                                    <div class="col-lg-12">
                                        ...
                                        <div class="table-container">
                                            ...
                                            <label class="col-sm-3">Tổng số: {{$total}} thành viên</label>
                                        </div>
                                    </div>
                                </div>
                            </div>
