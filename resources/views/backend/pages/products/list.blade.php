                    ...
                    <div class="col-lg-12">
                                ...
                                <div class="form-group">
                                    <div class="col-sm-6">
                                        <div class="input-group">
                                            <input class="form-control" name="search" value="" placeholder="Nhập tên hoặc id sản phẩm">
                        ...
                        <div id="tableactionTabContent" class="tab-content">
                         <div class="portlet-header pam mbn">
                            <div class="actions"><a href="{{asset('admin/san-pham/them-moi')}}" class="btn btn-info btn-sm"><i class="fa fa-plus"></i>&nbsp;
                                Thêm mới</a>&nbsp;
                            </div>
                        </div>
                                        ...
                                        <div class="table-container">
                                            <table class="table table-hover table-striped table-bordered table-advanced tablesorter">
                                                ...
                                                <tr>
                                                    ...
                                                    <td>{{ $item -> id }}</td>
                                                    <td><img src="{{asset('public/home/images/products/'.$item -> image)}}" width="50" height="50"/></td>
                                                    <td>{{ $item->name }}</td>
                                                    <td>{{ $item->price }}</td>
                                                    <td>{{ $item->quantity }}</td>
                                                    <td>
